...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS 应用开发} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{30pt}{\baselineskip}\selectfont \textbf{应用开发}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'应用开发',
     u'远景智能', 'book', 'true'),
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Application Development',
     author, 'EnOSDocumentationCenter', 'Product documentation about EnOS Application Development.',
     'Miscellaneous'),
]
