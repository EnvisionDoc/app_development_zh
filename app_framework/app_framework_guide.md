...
2. 点击 **+创建应用** 按钮，在 **创建应用** 窗口，输入应用名、应用链接、应用描述，选择背景颜色和应用图标。
...
为公司分配的公有应用将会被列入公司的 **应用注册** 页面表格中。公司的组织管理员可将分配的公有应用权限开放给用户。
...
2. 在系统管理页面左侧任务栏，点击 **应用注册**。

3. 点击 **+创建应用** 按钮，在 **创建应用** 弹窗内，输入应用名、应用链接、应用描述，选择背景颜色和应用图标。

4. 点击 **保存**，完成私有应用注册。

注册完成之后，所有已注册的私有应用和分配给组织的公有应用信息会显示在应用注册页面的表格中。在该表格中，可以更新私有应用的状态、编辑应用信息、定义应用权限，如下图所示。
...
如需为指定用户设置与组织管理员相似的平台管理权限，可在上图所示的账号管理页面，点击Settings Group。然后选择授权给用户的管理权限，包括用户管理、应用注册、和桌面配置权限。
